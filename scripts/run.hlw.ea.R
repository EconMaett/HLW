...
working.dir <- "Holston-Laubach-Williams/HLW_2023_Replication-Code/"

# Location of model code files
code.dir <- "Holston-Laubach-Williams/HLW_2023_Replication-Code/"
...
# LOAD CODE PACKAGES ----
# setwd(code.dir)
source(paste0(code.dir, "kalman.log.likelihood.R"))
source(paste0(code.dir, "kalman.states.R"))
source(paste0(code.dir, "median.unbiased.estimator.stage1.R"))
source(paste0(code.dir, "median.unbiased.estimator.stage2.R"))
source(paste0(code.dir, "utilities.R"))
source(paste0(code.dir, "run.hlw.estimation.R"))
source(paste0(code.dir, "unpack.parameters.stage1.R"))
source(paste0(code.dir, "unpack.parameters.stage2.R"))
source(paste0(code.dir, "unpack.parameters.stage3.R"))
source(paste0(code.dir, "kalman.states.wrapper.R"))
source(paste0(code.dir, "log.likelihood.wrapper.R"))
source(paste0(code.dir, "calculate.covariance.R"))
source(paste0(code.dir, "rstar.stage1.R"))
source(paste0(code.dir, "rstar.stage2.R"))
source(paste0(code.dir, "rstar.stage3.R"))
source(paste0(code.dir, "format.output.R"))
source(paste0(code.dir, "kalman.standard.errors.R"))
...
ea.data <- read.xlsx(paste0(working.dir, "inputData/Holston_Laubach_Williams_current_estimates.xlsx"),
  sheet = "EA input data",
...
# ESTIMATION ----
ea.estimation <- run.hlw.estimation(
  log.output = ea.log.output,
...
one.sided.est.ea <- cbind(
  ea.estimation$out.stage3$rstar.filtered,
...
two.sided.est.ea <- cbind(
  ea.estimation$out.stage3$rstar.smoothed,
...
output.ea <- format.output(
  country.estimation = ea.estimation,
...
# Save output to CSV
write.table(output.ea, paste0(working.dir, "output/output.ea.csv"), col.names = TRUE, quote = FALSE, row.names = FALSE, sep = ",", na = "")
