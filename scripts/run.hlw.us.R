...
us.data <- read.xlsx(paste0(working.dir, "inputData/Holston_Laubach_Williams_current_estimates.xlsx"),
  sheet = "US input data",
...
# Save output to CSV
write.table(output.us, paste0(working.dir, "output/output.us.csv"), col.names = TRUE, quote = FALSE, row.names = FALSE, sep = ",", na = "")
