...
ca.data <- read.xlsx(paste0(working.dir, "inputData/Holston_Laubach_Williams_current_estimates.xlsx"),
  sheet = "CA input data",
...
# Save output to CSV
write.table(output.ca, paste0(working.dir, "output/output.ca.csv"), col.names = TRUE, quote = FALSE, row.names = FALSE, sep = ",", na = "")
