...
# given state-space model and the conditional expectation and covariance matrix 
# of the initial state and returns a vector with the log likelihood value from 
# each period, as well as the cumulative sum.
#------------------------------------------------------------------------------#
